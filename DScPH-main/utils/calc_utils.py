...
# def calc_map_k(qB, rB, qL, rL, topk=50) -> float:
#     """
...
#         hamming_dist = (0.5 * (rB.shape[1] - qB[i, :] @ rB.T)).to(1)
...
#         score = torch.linspace(1, retrieval_cnt, retrieval_cnt).to(1)
#         # Acquire index
...
def calc_map_k_matrix(qB, rB, query_L, retrieval_L, k=5000, rank=0):
